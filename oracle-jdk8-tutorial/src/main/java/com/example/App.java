/*
/*  El alcance o ambito (scope) de los elementos de una clase que tambien se leslklama
 *  los miembros de una clase, que pueden ser tantos los campos, variables miembros, propiedades
 ...
 *  
 *  ¿Que quiere decir que un elemento viva en el Plano de las Clases?
 *  
 ...
 *  Por el modificador static que llevaria delaqnte si se trata de un elemento que
...
public class App {
	...
	//La variable siguiente es una variable de Clase porque lleva el modificador static
	
	static double salario = 3500.25;

	public static void main(String[] args) {
		
		// Imprimir el valor de una variable, o campo de la clase , variable1
